...
public class CreateTopic {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        KafkaFuture<Void> future = client
                .createTopics(Collections.singleton(new NewTopic("epics-channels", partitions, replicationFactor)),
        ...
        updateConfig.put(resource, Collections.singleton(new AlterConfigOp(entry, AlterConfigOp.OpType.SET)));
